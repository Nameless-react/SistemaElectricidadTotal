...
export default function Add() {
    ...
    return (
        <div className='flex-grow mx-auto max-w-7xl pt-10 px-6'>
            <h1 className="text-3xl text-center mb-8 font-semibold mt-10 text-white">Agregar Equipo</h1>
                ...
                <form>
                        ...
                        <div className='flex flex-col w-1/2'>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <DropdownItem key="en_reparacion">En Reparación </DropdownItem>
                                </DropdownMenu>
                            </Dropdown>
                        </div>
                        <div className='flex flex-col w-1/2'>
                    ...
                    <div className="flex justify-center gap-4 mb-5  items-center">
                        <div className='flex flex-col w-1/2'>
                            <Input
                                bordered
                                label="Vida Util Estimada (meses)"
                                labelPlacement="outside"
                                placeholder="Vida Util Estimada (meses)"
                                color="default "
                                className="dark w-full"
                                size="md"
                            />
