...
export default function EditAppointment() {
    ...
    const appointmentData = {
        date: '2024-08-10',
        description: 'Reunión con cliente A',
        direction: 'Dirección A',
        isOffice: true
    };
        ...
        <>
            ...
            >
                ...
                <div className="w-[650px] flex justify-center items-center">
                    <DateAppointment label="Fecha" defaultValue={appointmentData.date} />
                </div>
                ...
                <div className="w-full max-w-md">
                    <Textarea
                        ...
                        defaultValue={appointmentData.direction}
                        className="text-white dark rounded-lg"
                    />
                    <div className="flex items-center mt-4">
                        <p className="text-sm">¿Desea Agendar Cita en la oficina de Electricidad Total?</p>
                        <input type="checkbox" defaultChecked={appointmentData.isOffice} className="dark ml-2 h-4 w-4" />
                    </div>
                </div>
