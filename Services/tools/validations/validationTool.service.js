    ...
    async validateTool(formData) {
        try {
            ...
            const formattedData = {
                ...
                date: new Date(parsedData.date) || null,
                image: (typeof parsedData.image === "string" || (parsedData.image && parsedData.image.name))
                    ? (typeof parsedData.image === "string" ? parsedData.image : parsedData.image.name)
                    : ""
            };
