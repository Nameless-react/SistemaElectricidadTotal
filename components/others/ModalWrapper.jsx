...
export default function ModalWrapper({ children, modalTitle, buttonComponent, modalSize, backdrop, classNameButton }) {
    const { isOpen, onOpen, onOpenChange } = useDisclosure();

    return (
        <>
            <Button className={classNameButton || "max-w-10 outline-none bg-green-700 text-xl"} onPress={onOpen}>
                {buttonComponent || "+"}
            </Button>
