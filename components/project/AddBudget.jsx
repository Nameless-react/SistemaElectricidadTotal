...
export default function AddBudget() {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center justify-center gap-6">
            <Input label="Monto" {...register("amount")} isInvalid={errors?.amount} errorMessage={errors?.amount?.message} classNames={{ inputWrapper: "bg-[#182237] dark:hover:bg-sky-900 dark:active:bg-sky-900 dark:focus:bg-sky-900 dark:focus-within:bg-sky-900" }} />
