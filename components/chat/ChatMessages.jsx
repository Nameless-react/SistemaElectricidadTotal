...
//todo
//* Corregir que las palabras únicas muy largas no se salen del cuadro del mensaje

export default function ChatMessages() {
    const [messages, setMessages] = useState(["ajflskdjf"]);
    ...
    const componentsMessages = messages.map(message => (
        <Message 
            message={message}
            authorEmail={null}
            author={"Joel"}
